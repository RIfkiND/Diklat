    ...
    <section class="grid grid-cols-2 gap-y-5">
        ...
        <div class="flex justify-center">
            <div class="space-y-2">
                ...
                @if($biodata->petugas1)
                    <p>Petugas 1,</p>
                    <img src="{{ $biodata->petugas1->profile_picture ?? '' }}" alt="Petugas 1" class="w-32 h-32">
                    <div>
        ...
        <div class="flex justify-center">
            <div class="space-y-2">
                ...
                @if($biodata->petugas2)
                    <p>Petugas 2,</p>
                    <img src="{{ $biodata->petugas2->profile_picture ?? '' }}" alt="Petugas 2" class="w-32 h-32">
                    <div>
    ...
    @endforeach
        ...
        <div class="flex justify-center">
            <div class="gap-2 flex flex-col">
                <p>Kepala SMKN 3 Yoyakarta</p>
                <img src="" alt="" class="w-32 h-32 mt-6">
                <div class="">
